...
var ru = __webpack_require__(2271);
// EXTERNAL MODULE: ./node_modules/flatpickr/dist/l10n/ru.js
var l10n_ru = __webpack_require__(6775);
;// CONCATENATED MODULE: ./src/js/TripCalendar.js
...
class TripCalendar {
  ...
  init() {
    ...
    this.initFlatpickr();
    this.today = moment_default()().format("YYYY-MM-DD");
  ...
  checkReturnDateValidity() {
    if (this.roundTripCheckbox.checked) {
      const departureDate = moment_default()(this.departureDate.value);
      const returnDate = moment_default()(this.returnDate.value);
      if (returnDate.isBefore(departureDate)) {
        this.returnDate.setCustomValidity("Дата возврата должна быть позже даты отправления");
      } else {
  ...
  loadFormData() {
    ...
    if (savedData.departureDate) this.departureDate.value = savedData.departureDate;
    if (savedData.returnDate) this.returnDate.value = savedData.returnDate;
    if (savedData.roundTrip) this.roundTripCheckbox.checked = savedData.roundTrip;
...
/* harmony default export */ const js_TripCalendar = (TripCalendar);
;// CONCATENATED MODULE: ./src/js/app.js

document.addEventListener("DOMContentLoaded", () => {
  new js_TripCalendar("#trip-form");
});
